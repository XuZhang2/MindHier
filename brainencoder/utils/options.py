...
parser.add_argument(
    "--model_name", type=str, default="testing_promote_gt_600e_ema",
...
parser.add_argument(
    "--retrival_from_memory", action=argparse.BooleanOptionalAction, default=True,
    help='Wheather to retrive data from memory',
)
parser.add_argument(
    "--retrival_from_memory_strength", type=float, 
    help='retrive data from memory alpha',
)
parser.add_argument(
...
parser.add_argument(
    "--guidance", dest="guidance_scale", type=float,
    help="Alias for --guidance_scale, kept for compatibility with inference.sh.",
)
parser.add_argument(
    "--num_inference_steps", "-num_inference_steps", type=int, default=20,
...
parser.add_argument(
    "--vd_cache_dir", type=str, default='pretrained/versatile-diffusion',
    help="Local cache directory for Versatile Diffusion weights.",
)
parser.add_argument(
    "--rec_timestamp", type=str,
)
parser.add_argument(
    "--train_logs_dir", type=str, default="outputs/brainencoder",
    help="Directory containing Stage 1 fMRI-to-CLIP checkpoints.",
)
parser.add_argument(
    "--autoencoder_root", type=str, default="outputs/autoencoder",
    help="Directory containing low-level autoencoder checkpoints.",
)
parser.add_argument(
    "--memory_features_dir", type=str, default="data/extracted_features",
    help="Directory containing optional retrieved CLIP feature memories.",
)
parser.add_argument(
    "--recon_output_dir", type=str, default="outputs/recon",
...
parser.add_argument(
    "--response_path", type=str, default=None,
    help="path to reconstructed outputs",
)
